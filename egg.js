...
window.addEventListener('DOMContentLoaded', (event) => {
    ...
    class Pan{
        ...
        draw(){
            ...
            let link3 = new LineOP(this.edge4, this.edge1, "gray", 23)
            ...
            for(let t = 0;t<this.eggs.length;t++){
                ...
                for(let k = 0;k<this.eggs[t].albumen.length;k++){
                if(this.frying.doesPerimeterTouch(this.eggs[t].albumen[k].body)){
                ...
                if(this.frying.doesPerimeterTouch(this.eggs[t].albumen[k].anchor)){
